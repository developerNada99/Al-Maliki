    ...
    <div className="overflow-x-hidden">
      ...
      <div className="relative w-screen h-screen overflow-hidden">
        ...
        <div className="absolute z-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex justify-center flex-col items-center w-full text-white">
          ...
          <p className="text-lg md:text-2xl mb-40 text-gray-400 text-center max-lg:w-3xl">
...
>
  ...
  <div>حل ملاحظة حماية الاجور</div>
          ...
          <button className="bg-white text-black mt-16 py-2 px-6 rounded-full hover:bg-gray-200 transition">
            اعرف المزيد
          </button>
        </div>
      </div>
